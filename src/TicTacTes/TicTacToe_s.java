...
public class TicTacToe_s extends javax.swing.JFrame {
    ...
    private void winner(){
    if(xCount > oCount){
            jButton10.setText("Winner:X");
        }
    else if(xCount < oCount) {
            jButton10.setText("Winner:O");
        }
    else if((xCount == oCount) && (xCount>=1)&& (oCount>=1)){
  ...
  private void winningGame(){
     ...
     {
          JOptionPane.showMessageDialog(this, "OOPS TRY AGAIN!!", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
          reset();
      } 
  }
    ...
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExitActionPerformed
        ...
        frame = new JFrame("Exit example");
        if (JOptionPane.showConfirmDialog(frame,"Are you sure you want to exit?","Please confirm",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION ) {
            System.exit(0);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:jButton1.setText(startGame);
        count++;
